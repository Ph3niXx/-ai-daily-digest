...
- **Masquage des offres clôturées** : quand une offre LinkedIn passe en "ne recrute plus" (détecté par le scan Cowork quotidien), elle est retirée du feed actif et des hot leads. Un filtre « Clôturées » permet de les revoir ; un compteur dans l'en-tête indique combien sont masquées. Une offre déjà postulée reste visible dans le pipeline.
