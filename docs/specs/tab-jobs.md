...
- **Vote 👍/👎 + raison par offre** : sur chaque carte (hot lead) et chaque ligne dense, l'utilisateur note l'offre. Un pouce ouvre des puces-raison en un clic (👎 : trop junior / run-BAU / secteur / boîte / lieu / bof ; 👍 : scope / secteur / boîte / coup de cœur) avec un « préciser… » en texte libre. Re-cliquer le pouce actif annule le vote. Signal persisté, hérité à la republication (fenêtre 180j), destiné à calibrer le scoring Cowork.
