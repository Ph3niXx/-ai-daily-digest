...
- **Routine Claude Code distante** (claude.ai, hors repo GitHub Actions — ADR-19) — responsable de :
  ...
  4. **Extraction des skills** de l'annonce + match au profil (`skill_radar` + `user_profile`) → `intel.skills_required [{ name, on_cv }]`
