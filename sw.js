...
const CACHE = "cockpit-v89";

const STATIC = [
  "/",
  "/cockpit/app.jsx?v=34",
  ...
  "/cockpit/data.js",
  "/cockpit/home.jsx?v=7",
  "/cockpit/icons.jsx?v=3",
  "/cockpit/lib/anilist.js?v=2",
  "/cockpit/lib/auth.js?v=2",
  "/cockpit/lib/bootstrap.js?v=2",
  "/cockpit/lib/data-loader.js?v=39",
  "/cockpit/lib/dialog.js?v=1",
  "/cockpit/lib/mediatheque-view.js?v=3",
  "/cockpit/lib/snooze.js?v=1",
  "/cockpit/lib/supabase.js?v=1",
  "/cockpit/lib/telemetry.js?v=1",
  "/cockpit/lib/tmdb.js?v=1",
  "/cockpit/lib/wiki-tooltip.js?v=2",
  "/cockpit/nav.js?v=2",
  "/cockpit/panel-challenges.jsx?v=5",
  "/cockpit/panel-evening.jsx?v=1",
  "/cockpit/panel-forme.jsx?v=4",
  "/cockpit/panel-gaming.jsx?v=7",
  "/cockpit/panel-history.jsx?v=5",
  "/cockpit/panel-ideas.jsx?v=7",
  "/cockpit/panel-jarvis-lab.jsx?v=7",
  "/cockpit/panel-jarvis.jsx?v=5",
  "/cockpit/panel-jobs-radar.jsx?v=5",
  "/cockpit/panel-mediatheque.jsx?v=7",
  "/cockpit/panel-musique.jsx?v=6",
  "/cockpit/panel-opportunities.jsx?v=6",
  "/cockpit/panel-profile.jsx?v=4",
  "/cockpit/panel-radar.jsx?v=5",
  "/cockpit/panel-recos.jsx?v=5",
  "/cockpit/panel-review.jsx?v=1",
  "/cockpit/panel-search.jsx?v=5",
  "/cockpit/panel-signals.jsx?v=9",
  "/cockpit/panel-stacks.jsx?v=3",
  "/cockpit/panel-top.jsx?v=1",
  "/cockpit/panel-veille-outils.jsx?v=2",
  "/cockpit/panel-veille.jsx?v=11",
  "/cockpit/panel-week.jsx?v=1",
  "/cockpit/panel-wiki.jsx?v=6",
  "/cockpit/sidebar.jsx?v=7",
  "/cockpit/styles-challenges.css?v=5",
  "/cockpit/styles-evening.css?v=1",
  "/cockpit/styles-forme.css?v=2",
  "/cockpit/styles-gaming.css?v=6",
  "/cockpit/styles-history.css?v=1",
  "/cockpit/styles-ideas.css?v=2",
  "/cockpit/styles-jarvis-lab.css?v=11",
  "/cockpit/styles-jarvis.css?v=7",
  "/cockpit/styles-jobs-radar.css?v=5",
  "/cockpit/styles-mediatheque.css?v=6",
  "/cockpit/styles-mobile.css?v=3",
  "/cockpit/styles-musique.css?v=2",
  "/cockpit/styles-opportunities.css?v=5",
  "/cockpit/styles-profile.css?v=5",
  "/cockpit/styles-radar.css?v=4",
  "/cockpit/styles-recos.css?v=4",
  "/cockpit/styles-signals.css?v=4",
  "/cockpit/styles-stacks.css?v=5",
  "/cockpit/styles-veille-outils.css?v=3",
  "/cockpit/styles-wiki.css?v=7",
  "/cockpit/styles.css?v=35",
